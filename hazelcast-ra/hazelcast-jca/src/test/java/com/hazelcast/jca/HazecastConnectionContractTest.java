...
public class HazecastConnectionContractTest {
    ...
    private Set<String> hazelcastInstanceOnlyMethods = new HashSet<String>(Arrays.asList(
            ...
            "getConfig",                        //TODO: ???
            "getName",                          //TODO: ???
            "getUserContext",                   //TODO: Do we want to explose this via JCA?
            "getDistributedObject",             //TODO: Do we want to explose this via JCA?
            "getDistributedObjects",            //TODO: Do we want to explose this via JCA?
            "executeTransaction",               //TODO: ??
            "getJobTracker",                    //??
            "getPartitionService",              //??
            "getLoggingService",                //??
            "getClientService",                 //??
            "removeDistributedObjectListener",  //?? classloading issues?
            "addDistributedObjectListener"      //?? classloading issues?
    ));
    ...
    public void verifyContractsOfMethods() {
        for (Method method : getPublicMethods(HazelcastInstance.class)) {
            ...
            assertTrue(HazelcastConnection.class.getName()+" doesn't have method "+method, isIgnored || hasSameContract);
        }
    }
