...
public final class WriteHandler extends AbstractSelectionHandler implements Runnable {
    ...
    private final Queue<SocketWritable> writeQueue = new MpscArrayQueue<SocketWritable>(1000);
    private final Queue<SocketWritable> urgentWriteQueue = new MpscArrayQueue<SocketWritable>(1000);
