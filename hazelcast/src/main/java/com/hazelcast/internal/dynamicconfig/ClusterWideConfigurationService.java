...
public class ClusterWideConfigurationService implements MigrationAwareService,
    ...
    private ConcurrentMap<String, ReliableTopicConfig> reliableTopicConfigs = new ConcurrentHashMap<String, ReliableTopicConfig>();
    private ConcurrentMap<String, CacheSimpleConfig> cacheSimpleConfigs = new ConcurrentHashMap<String, CacheSimpleConfig>();
